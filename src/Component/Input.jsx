                    ...
                    {/* box1,2,3 */}
                            <div className='flex flex-col md:grid md:grid-cols-3 gap-14 md:gap-5 pt-10 z-3'>
                                ...
                                <div className='flex flex-col items-center gap-3 bg-white text-center px-5 pt-12 py-10 rounded-sm text-balance md:pl-4 md:px-2 md:text-start relative'>
                                    ...
                                    <p className='text-gray-500 text-[14px] md:text-[18px]  text-balance md:text-start'>Boost your brand recognition with each click. Generic links don’t mean a thing. Branded links help instil confidence in your content.
                                    </p>
                                </div>
                                ...
                                <div className='flex flex-col items-center gap-3 bg-white text-center px-5 pt-12 py-10 rounded-sm text-balance md:pl-4 md:px-2 md:text-start relative md:top-8'>
                                    ...
                                    <p className='text-gray-500  text-[14px] md:text-[18px]  text-balance md:text-start'>Gain insights into who is clicking your links. Knowing when and where people engage with your content helps inform better decisions.
                                    </p>
                                </div>
                                ...
                                <div className='flex flex-col items-center gap-3 bg-white text-center px-5 pt-12 py-10 rounded-sm text-balance md:pl-4 md:px-2 md:text-start relative md:top-15'>
                                    ...
                                    <p className='text-gray-500 text-[14px] md:text-[18px] text-balance md:text-start'>Improve brand awareness and content discoverability through customizable links, supercharging audience engagement.
                                    </p>
                                </div>
                            </div>
                </div>
